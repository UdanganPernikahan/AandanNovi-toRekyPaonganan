...
export default function Hero() {
  return (
    <section className="relative min-h-[100dvh] flex flex-col items-center justify-center p-3 sm:p-4 md:p-10 bg-ivory overflow-hidden">
      ...
      <div className="relative z-10 w-full h-full border-[8px] sm:border-[12px] border-sage-500/10 rounded-2xl sm:rounded-3xl flex flex-col items-center justify-center text-center p-4 sm:p-8 overflow-hidden bg-ivory/40">
        ...
        >
          <div className="mb-8 sm:mb-12 flex flex-col items-center">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-gold w-10 h-10 sm:w-12 sm:h-12 mb-6 sm:mb-8">
