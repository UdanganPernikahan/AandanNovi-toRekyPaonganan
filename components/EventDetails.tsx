          ...
          >
            ...
            <div className="grid grid-cols-1 gap-8 text-center w-full max-w-sm">
              ...
              <div>
                ...
                <a href="https://maps.app.goo.gl/npv3FmMruot7uaZo8" target="_blank" rel="noopener noreferrer" className="text-sage-800 text-xl font-semibold underline decoration-gold">
                  Lihat Peta
                </a>
              </div>
            </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-8 text-center w-full max-w-sm">
              ...
              <div>
                ...
                <a href="https://maps.app.goo.gl/5Nxe9hfWyn1T9jyW7" target="_blank" rel="noopener noreferrer" className="text-sage-800 text-xl font-semibold underline decoration-gold">
                  Lihat Peta
                </a>
              </div>
            </div>
