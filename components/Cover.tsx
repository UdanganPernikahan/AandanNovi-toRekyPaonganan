...
+          <button 
+            onClick={onOpen}
+            className="flex items-center gap-2 bg-gold hover:bg-gold/80 text-white px-8 py-4 rounded-full font-sans text-sm font-medium transition-all duration-300 transform hover:scale-105 shadow-lg"
