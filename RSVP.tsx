        ...
        {isSubmitted ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-10 w-full max-w-lg">
            <div>
              ...
              <input required type="text" id="name" className="w-full bg-transparent border-b border-tan py-2 text-sage-800 font-serif text-lg focus:outline-none focus:border-sage-500 transition-colors placeholder:text-gray/40" placeholder="Masukkan nama Anda" />
            </div>
            <div>
              ...
              <select required id="attendance" className="w-full bg-ivory border-b border-tan py-2 text-sage-800 font-serif text-lg focus:outline-none focus:border-sage-500 transition-colors appearance-none cursor-pointer">
            ...
            <div>
              ...
              <select required id="guests" className="w-full bg-ivory border-b border-tan py-2 text-sage-800 font-serif text-lg focus:outline-none focus:border-sage-500 transition-colors appearance-none cursor-pointer">
            ...
            <div>
              ...
              <textarea rows={4} id="message" className="w-full bg-transparent border-b border-tan py-2 text-sage-800 font-serif text-lg focus:outline-none focus:border-sage-500 transition-colors resize-none placeholder:text-gray/40" placeholder="Tuliskan harapan baik Anda..."></textarea>
            </div>
            <button type="submit" className="mt-8 bg-sage-800 text-white px-10 py-4 rounded-full font-sans text-sm tracking-[0.2em] uppercase hover:bg-sage-500 transition-colors shadow-lg w-full md:w-auto self-center">
              Kirim Konfirmasi
            </button>
          </form>
        )}
